    ...
    <div class="portlet-body form">
        <form id='user_edit' class="form-horizontal" action="<?php echo site_url('user_admin/user_edit_save')?>">
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">义工项目</label>
                    <div class="col-md-9">
                        ...
                        <input name="profile[service_items][]" type="checkbox" value="<?=$team['id']?>" <?=in_array($team['id'], $profile->service_items) ? "checked" : ""?> > <?=$team['name']?>
                        </label>
                        <?php endforeach; ?>
                    </div>
                </div>
