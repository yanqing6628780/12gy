                ...
                <div class="table-scrollable">
                    <table class='table table-striped table-bordered table-hover'>
                        ...
                        <?php foreach($result as $key => $row):?>
                            <tr>
                                <td><?=$row['name'] ? $row['name'] : $row['uc_name']?></td>
                                <td><?=$row['phone'] ? $row['phone'] : $row['uc_phone']?></td>
                                <td>
                                    <?php if( chk_perm_to_bool('v_campaign_admin') || chk_perm_to_bool('c_campaign_admin') || chk_perm_to_bool('b_campaign_admin') ):?>
...
function del(id){
    $.ajax({
        url: '<?=site_url($controller_url."signup_log_del")?>',
        type: 'POST',
        dataType: 'json',
        data: {id: id},
