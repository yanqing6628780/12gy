    ...
    <div class="col-md-12">
        <div class='portlet box light-grey'>
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a onclick="add()" class="btn blue" ><i class="icon-plus"></i> 添加</a>
                </div>
            </div>
...
function del(id, table){
    common_del('<?=site_url($controller_url."del")?>', id, table, "<?php echo $ajax_view?>");
}
function is_show(id, status){
    ajaxPost('<?=site_url($controller_url."edit_save/")?>', {id: id,is_show: status}, "<?php echo $ajax_view?>");
}
function infoQuery() {
