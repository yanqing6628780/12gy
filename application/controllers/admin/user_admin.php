...
class User_admin extends CI_Controller
{
    ...
    public function user_add()
    {
        ...
        // $data['service_items'] = $this->config->item('service_items');
        // $data['star_service_items'] = $this->config->item('star_service_items');

        $data['serviceteam_category'] = $this->db->get("serviceteam_category")->result_array();
        $data['serviceteam'] = $this->db->get("serviceteam")->result_array();
    ...
    public function user_edit()
    {
        ...
        $data['profile']->service_items = $data['profile']->service_items == "" ? array()  : explode(',', $data['profile']->service_items);
        // $data['profile']->star_service_items = $data['profile']->star_service_items  == "" ? array()  : explode(',', $data['profile']->star_service_items);
