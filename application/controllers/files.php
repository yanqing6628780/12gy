...
class Files extends CI_Controller
{
    ...
    public function imgUpload()
    {
        ...
        else
        {
            ...
            if($upload_data['image_width']/$upload_data['image_height'] != $config['max_width']/$config['max_height']){
                $data = array('error' => '上传的图片比例不对,请上传16:9的图片');
                unlink($path.$upload_data['file_name']);
            }else{            
